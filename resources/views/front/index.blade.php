...
<div class="p-1 text-white text-center" style="background-image: url(assets/img/bg/12.jpg)">Up to 15% off</div>
    ...
    <div class="slider-area">
        <div class="slider-active-2 owl-carousel">
            <div class="single-slider-4 bg-img furits-slider" style="background-image: url(assets/img/slider/carousel.png)">
                <div class="container">
    ...
    <div class="product-style-area gray-bg-4 pb-105">
        ...
        <div class="container">
            ...
            <div class="section-title-furits bg-shape text-center mb-80">
                <img src="{{ asset('assets/img/icon-img/49.png') }}" alt="">
                    ...
                    <div class="col-lg-4 col-xl-3 col-md-6">
                        ...
                        <div class="product-fruit-img">
                            @if($product->media->count() > 0)
                                <img src="{{asset('uploads/products/'.$product->media->first()->file_name) }}">
                            @else
    ...
    <!-- banner area start -->
    <div class="fruits-choose-area pb-65 bg-img" style="background-image: url(assets/img/banner/53.png)">
        <div class="container">
            <div class="row">
