                            ...
                            <div class="product-details-large tab-content">
                                ...
                                @foreach ($product->media as $media)
                                    ...
                                    <div class="easyzoom easyzoom--overlay">
                                        @if($product->media)
                                        <a href="{{asset('uploads/products/'. $media->file_name) }}">
                                        <img src="{{asset('uploads/products/'.$media->file_name) }}" alt="{{ $product->name }}">
                                        </a>
                                        @else

                                        <img src="{{asset('uploads/products/default.jpg') }}" alt="">

                                        <img src="{{asset('uploads/default.jpg') }}" alt="">
                                ...
                                @endforeach
                                @else
                                <img src="{{ asset('uploads/default.jpg') }}" alt="{{ $product->name }}">
                                @endif
                            </div>
                            ...
                            <div class="product-details-small nav mt-12" role=tablist>
                                @foreach ($product->media as $media)
                                    <a class="{{ $loop->index == 0 ? 'active' : '' }} mr-12" href="#pro-details{{ $loop->index }}" data-toggle="tab" role="tab" aria-selected="true">
                                        <img style="width: 90px;" src="{{asset('uploads/products/'. $media->file_name) }}" alt="{{ $product->name }}">
                                    </a>
                                @endforeach
                            </div>
                                        ...
                                        <div class="blog-details content">
                                            <div class="comments_area">
                                                <ul class="comment__list">
                                                    ...
                                                    @forelse($product->approved_comments as $comment)
                                                        <li>
