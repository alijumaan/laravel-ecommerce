<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    @endforelse
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseLink"
           aria-expanded="true" aria-controls="collapseLink">
            <i class="fa fa-link"></i>
            <span>Link</span>
        </a>
        <div id="collapseLink" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Custom Components:</h6>
                <a class="collapse-item" href="{{ route('admin.links.index') }}">Links</a>
            </div>
        </div>
    </li>
    <!-- Divider -->
