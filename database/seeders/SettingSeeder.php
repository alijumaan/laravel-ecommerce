...
class SettingSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Setting::create(['display_name' => 'Google Maps API Key', 'key' => 'google_map_api_key', 'value' => null, 'type' => 'text', 'section' => 'social_account']);
        Setting::create(['display_name' => 'Google Recaptcha API key', 'key' => 'google_recaptcha_api_key', 'value' => null, 'type' => 'text', 'section' => 'social_account']);
        Setting::create(['display_name' => 'Google Analytics Client ID', 'key' => 'google_analytics_client_id', 'value' => null, 'type' => 'text', 'section' => 'social_account']);
        Setting::create(['display_name' => 'Twitter ID', 'key' => 'twitter_id', 'value' => 'https://www.twitter.com/Aalhbbash', 'type' => 'text', 'section' => 'social_account']);
    }
}
